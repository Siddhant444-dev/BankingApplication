...
public class BankStatement {
    ...
    private static final String FILE = "C:\\Users\\Public\\Documents\\MyStatement.pdf";
        ...
        List<Transaction> transactionList = transactionRepository.findAll().stream()
                ...
                .filter(transaction -> {
                    ...
                    return createdAt != null &&
                            (createdAt.isEqual(start) || createdAt.isAfter(start)) &&
            ...
            PdfPCell bankName = new PdfPCell(new Phrase("Banking Application Statement"));
            bankName.setBorder(0);
            bankName.setBackgroundColor(BaseColor.BLUE);
            bankName.setPadding(20f);

            PdfPCell bankAddress = new PdfPCell(new Phrase("123 Bank Street, City, Country"));
